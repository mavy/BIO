...
if FASTPhase1:
    ...
    matrix , SNPRecover = create_matrix(mapping, all_fenotypes, listInd)
    # pickle.dump(matrix, open("analisis4_allmatrix.p", "wb"))

matrix, SNPRecover = create_matrix(mapping, all_fenotypes, listInd)

pickle.dump(SNPRecover, open("analisis4_SNPList.p", "wb"))
print SNPRecover
print SNPRecover[5654]
...
#clf = GridSearchCV(tree.DecisionTreeClassifier(), parameters, n_jobs=4, verbose = 5)
